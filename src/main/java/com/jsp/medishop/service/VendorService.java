...
public interface VendorService {
	...
	List<Vendor> getVendorService();

	ResponseStructure<Vendor> loginVendorByEmailAndPasswordService(String email, String password);

	/**
	 * logout vendor from session
	 */
	ResponseEntity<String> logoutVendorService();

	ResponseEntity<String> vendorVerifyByIdService(int id);
